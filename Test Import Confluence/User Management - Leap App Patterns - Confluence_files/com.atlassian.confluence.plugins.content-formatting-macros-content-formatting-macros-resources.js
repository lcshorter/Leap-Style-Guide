...
Confluence.Templates.ContentFormatting.colgroup = function(opt_data, opt_ignored) {
  return '<colgroup' + ((opt_data.id) ? ' id="' + soy.$$escapeHtml(opt_data.id) + '"' : '') + ((opt_data['class']) ? ' class="' + soy.$$escapeHtml(opt_data['class']) + '"' : '') + ((opt_data.width) ? ' width="' + soy.$$escapeHtml(opt_data.width) + '"' : '') + ((opt_data.span) ? ' span="' + soy.$$escapeHtml(opt_data.span) + '"' : '') + '>' + soy.$$escapeHtml(opt_data.macroBodyWithHtml) + '</colgroup>';
};
if (goog.DEBUG) {
